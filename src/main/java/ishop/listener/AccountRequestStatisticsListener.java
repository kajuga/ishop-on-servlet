...
public class AccountRequestStatisticsListener implements ServletRequestListener {
    ...
    public void requestInitialized(ServletRequestEvent sre) {
        ...
        List<String> actions = (List<String>) req.getSession().getAttribute(Constants.ACCOUNTS_ACTIONS_HISTORY);
        if (actions == null) {
            actions = new ArrayList<>();
            req.getSession().setAttribute(Constants.ACCOUNTS_ACTIONS_HISTORY, actions);
        }
